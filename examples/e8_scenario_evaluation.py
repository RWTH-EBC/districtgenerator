...
def example8_scenario_evaluation():
    ...
    # Initialize District
    data = Datahandler(scenario_name = "small_district", heat_map_berlin=True)
    ...
    data.generateDistrictComplete(calcUserProfiles=False, saveUserProfiles=True, topology_option= "rode")
