...
def example8_1_generate_first_non_residential_district():
...
if __name__ == '__main__':
    print("Let's generate a Non-Residential district!")
    
    data = example8_1_generate_first_non_residential_district()
