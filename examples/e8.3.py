...
def example8_scenario_evaluation():
    ...
    # "A": "Papierindustrie", "B": "Milchverarbeitung", "C": "Rechenzentrum", "D": "Kläranlage", "E": "cold store"
    #data.generate_waste_heat_source(waste_heat_source="B", distance=800)
    data.generate_waste_heat_source(waste_heat_source="Papierindustrie", distance=1000)
