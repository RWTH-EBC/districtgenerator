...
class WaermecontractingKundenanlageBM(BusinessModelBase):
    ...
    def calculate_kpis(self, kpis, data, result: dict) -> None:
        ...
        bw_tac_corrected = (
                bw_tac_total
                + self._bw_constant_annual_vdi(pv_cost_ann_total)
                + self._bw_constant_annual_vdi(c_elgrid_ann)
                + bw_local_el_overcredit
                - bw_pv_op_rev_total
                - bw_residual_resale
        )
        ...
        kpis.kundenanlage_breakdown = {
            ...
            "bw_pv_cost_total": self._bw_constant_annual_vdi(pv_cost_ann_total),
            "c_elgrid_ann": c_elgrid_ann,
            "bw_elgrid": self._bw_constant_annual_vdi(c_elgrid_ann),
