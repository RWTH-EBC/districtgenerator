...
class Sun:
    ...
    def calcPVAndSTCProfile(self, time, site, area_roof, beta=35, gamma=0, usageFactorPV1=0.4, usageFactorPV2=0,
        ...
        area_roof : float
            Area of the building's roof for decentral building calculations. Set to 2 for central device calculations.
            The unit is [m²].
        ...
        usageFactorPV1/usageFactorPV2 : float, optional
            Ratio between area of all PV collectors on side 1/side 2 of the roof and the surface of that side of the roof.
        ...
        for t in range(time["timeSteps"]):
            generation_PV[t] = (0.5 * area_roof) * (1 - kappa_corr) * (
