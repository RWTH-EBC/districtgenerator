...
class BES:
    ...
    def designECS(self, building, site, dt_s):
        ...
        BES["heat_grid"] = 1 if (buildingFeatures["heater"] in ["heat_grid", "heat_grid_OEB", "heat_grid_BEB", "heat_grid_BHP"]) else 0
        ...
        for k in self.decentral_device_data.keys():
            ...
            if k == "EWH":
                if buildingFeatures["heater"] in ["heat_grid_OEB", "heat_grid_BEB"]:
            ...
            if k == "TES":
                ...
                if buildingFeatures["heater"] in ("heat_grid", "heat_grid_OEB", "heat_grid_BEB", "heat_grid_BHP", "DH"):
                    BES["TES"] = 0
                else:
    ...
    def _candidate_fixed_capacities(self, building, mode):
        ...
        fixed_common = {}
        if bf["heater"] in ("heat_grid", "heat_grid_OEB", "heat_grid_BEB", "heat_grid_BHP", "DH"):
    ...
    def _parse_heater_spec(self, heater_value):
        ...
        if is_custom:
            ...
            forbidden = {"DH", "HEAT_GRID", "heat_grid_OEB", "heat_grid_BEB", "HEAT_GRID_BHP", "HEATGRID", "HEAT-GRID"}
