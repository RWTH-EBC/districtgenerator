...
class BES:
    ...
    def designECS(self, building, site, dt_s):
        ...
        BES["heat_grid"] = 1 if (buildingFeatures["heater"] in ["heat_grid", "heat_grid_OEB", "heat_grid_BEB"]) else 0
        ...
        for k in self.decentral_device_data.keys():
            ...
            if k == "TES":
                ...
                if buildingFeatures["heater"] in ("heat_grid", "heat_grid_OEB", "heat_grid_BEB", "DH"):
                    BES["TES"] = 0
                else:
    ...
    def _candidate_fixed_capacities(self, building, mode):
        ...
        fixed_common = {}
        if bf["heater"] in ("heat_grid", "heat_grid_OEB", "heat_grid_BEB", "DH"):
