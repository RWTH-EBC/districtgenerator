...
class Envelope:
    ...
    file_path : str
        File path.
    teaser_id : int, optional
        Optinal parameter, for internal data management,
         as residental buildings are generated from a TEASER project.
    ...
    def calcNormativeProperties(self, SunRad, internal_gains):
        ...
        # TODO: Implement other options e.g.g sun blinds
        self.F_sh_gl = 1
        ...
        # Old: self.A_m = self.f_class["Am"] * self.A["f"]
        ...
        # Olds: self.H_tr_ms = self.f_class["Am"] * self.A["f"] * self.h_ms
    ...
    def validate_id(self, prj):
        ...
        try:  prj.buildings[self.id]
            ...
            print("The provided ID is not present in the TEASER project")
# %%
