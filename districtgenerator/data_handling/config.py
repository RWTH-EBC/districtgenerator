...
class DecentralDeviceConfig(BaseSettings):
    ...
    CC__inv_base: float = 700.0  # Unsubsidized investment variable in €/kW.
    ...
    HP__inv_base: float = 1950.0  # Unsubsidized investment variable in €/kWth.
    ...
    EH__inv_base: float = 620.0  # Unsubsidized investment variable in €/kW.
    ...
    BOI__inv_base: float = 420.0  # Unsubsidized investment variable in €/kW.
    ...
    BBOI__inv_base: float = 2200.0  # Unsubsidized investment variable in €/kW
    ...
    OBOI__inv_base: float = 779.0  # Unsubsidized investment variable in €/kW.
    ...
    H2BOI__inv_base: float = 390.0  # Unsubsidized investment variable in €/kW.
    ...
    CHP__inv_base: float = 3500.0  # Unsubsidized investment variable in €/kW.
    ...
    DH__inv_base: float = 60.93  # Unsubsidized investment variable in €/kW.
    ...
    FC__inv_base: float = 390.0  # Unsubsidized investment variable in €/kW.
    ...
    PV__inv_base: int = 250  # Unsubsidized investment variable in €/m^2.
    ...
    STC__inv_base: int = 400  # Unsubsidized investment variable in €/m^2.
    ...
    TES__inv_base: float = 11.0  # Unsubsidized investment variable in €/liter.
    ...
    BAT__inv_base: float = 850.0  # Unsubsidized investment variable in €/kWh.
    ...
    EV__inv_base: float = 0.0  # Unsubsidized investment variable in €/kWh.
...
class CentralDeviceConfig(BaseSettings):
    ...
    CHP__inv_cap1: float = 300  # Smallest capacity in kW. # New TJA
    CHP__inv_cap2: float = 5000  # Medium capacity in kW. # New TJA
    CHP__inv_cap3: float = 10000  # Large capacity in kW. # New TJA
    ...
    BOI__inv_cap1: float = 500  # Smallest capacity in kW. # New TJA
    BOI__inv_cap2: float = 10000  # Medium capacity in kW. # New TJA
    BOI__inv_cap3: float = 30000  # Large capacity in kW. # New TJA
    ...
    AirHP__inv_cap1: float = 300  # Smallest capacity in kW. # New TJA
    AirHP__inv_cap2: float = 10000  # Medium capacity in kW. # New TJA
    AirHP__inv_cap3: float = 20000  # Large capacity in kW. # New TJA
