...
class CentralDeviceConfig(BaseSettings):
    ...
    PV_feasible: bool = False       # Should this be considered for the central optimization.
    PV_eta: float = 0.199           # Electrical efficiency between 0 and 1.
    ...
    WAT_potential: int = 50000      # Maximum available potential in kW.
    ...
    CHP_feasible: bool = True       # Should this be considered for the central optimization.
    ...
    BOI_feasible: bool = True       # Should this be considered for the central optimization.
    BOI_inv_var: int = 138          # Investment variable in €/kW.
    BOI_eta_th: float = 0.99        # Thermal efficiency between 0 and 1.
    BOI_life_time: int = 25         # Maximum life time in years.
    BOI_cost_om: float = 0.014      # Cost of operation and maintenance as a percentage of investment.
    ...
    HP_feasible: bool = False       # Should this be considered for the central optimization.
    HP_CCOP_feasible: bool = True   # Should this be considered for the central optimization (constant COP).
    ...
    HP_inv_var: int = 1110          # Investment variable in €/kW.
    HP_life_time: int = 20          # Maximum life time in years.
    HP_cost_om: float = 0.033       # Cost of operation and maintenance as a percentage of investment.
    ...
    AirHP_inv_var: int = 1110       # Investment variable in €/kWth.
    AirHP_cost_om: float = 0.033    # Cost of operation and maintenance as a percentage of investment.
    ...
    EB_inv_var: float = 32.73       # Investment variable in €/kW.
    ...
    EB_max_cap: int = 10000         # Maximum capacity in kW.
    ...
    BCHP_inv_var: int = 1140        # Investment variable in €/kW.
    ...
    BBOI_inv_var: int = 570         # Investment variable in €/kW.
    ...
    TES_inv_var: int = 550          # Investment variable in €/m^3.
    TES_sto_loss: float = 0.01      # Storage loss per hour as a fraction.
    TES_life_time: int = 20         # Maximum life time in years.
    TES_cost_om: float = 0.013      # Cost of operation and maintenance as a percentage of investment.
    ...
    CTES_delta_T: int = 30          # Temperature difference between charged and discharged state
